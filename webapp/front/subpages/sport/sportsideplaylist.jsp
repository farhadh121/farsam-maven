...
<%@ page import="com.radio.svc.exceptions.GenreExistException" %>
<%@ page import="com.radio.entity.hibernate.GenreEntity" %>
<%@ page import="com.radio.svc.exceptions.GenreNotExistsException" %>
...
<div class="m-t-n-xxs item pos-rlt">
    ...
    <%
        ...
        String genreForPresetStation = request.getParameter("genre");
        ...
        IGenreServiceProvider sideGenre = (IGenreServiceProvider) sideContext.getBean("genreFacade");
    ...
    <div class="pos-rlt">
        ...
        <img id="songArtworkSetter" class="img-full" src="" alt="..." style="z-index: -1">
    ...
    <!-- Like Dislike Button-->
        ...
        <div class="like-btn" onclick="passTheLikeButton();" style="background-color: #ffffff;">Like</div>
