...
@Controller
public class ChangeSongNameController {
    ...
    @ResponseBody
    public String changeSongName( @RequestBody String json ) throws Exception{

        ObjectMapper objectMapper = new ObjectMapper();
        ChangeSongNameRequest changeSongNameRequest = objectMapper.readValue(json, ChangeSongNameRequest.class);

        try{
            songServiceProvider.changeSongName( changeSongNameRequest.getId(), changeSongNameRequest.getName() );
