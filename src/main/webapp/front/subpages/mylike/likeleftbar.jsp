...
<nav class="nav-primary hidden-xs">
    <ul class="nav bg clearfix">
        ...
        <li>
            <a href="index.jsp">
                <i class="icon-home icon text-primary-lter"></i>
                <span class="font-bold">Home</span>
            </a>
        </li>

        <li>
            <a href="../front/events.html">
        ...
        <li>
            <a href="../front/privacypolicy.jsp">
                <i class="icon-briefcase icon text-success"></i>
                <span class="font-bold">Privacy Policy</span>
            </a>
        </li>
        <li>
            <a href="../front/aboutus.jsp">
                <i class="icon-user icon text-primary-lter"></i>
                <span class="font-bold">About Us</span>
            </a>
        </li>
        <li>
            <a href="../front/contact.jsp">
        ...
        <!--
        <li>
            <a href="../front/video.html" data-target="#content" data-el="#bjax-el" data-replace="true">
...
<!--
<footer class="footer hidden-xs no-padder text-center-nav-xs" style="margin-bottom: 83%">
