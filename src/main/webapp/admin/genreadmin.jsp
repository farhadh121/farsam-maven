...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            <h1>
                Dashboard
                <small>Genre Management Panel</small>
            </h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
            ...
            <!--Add Genre Module-->
            <%@ include file="subpages/addgenre.jsp" %>

            <!--List Genres Module-->

            <%@ include file="subpages/listgenres.jsp" %>

            <!-- Edit Genre Module-->
            <%@ include file="subpages/editgenre.jsp" %>
            
            <!-- Suggest Genres Module -->
            <%@ include file="subpages/suggestgenre.jsp" %>
