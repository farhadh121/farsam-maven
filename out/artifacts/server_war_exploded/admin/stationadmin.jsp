...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            <h1>
                Dashboard
                <small>Stations Management Panel</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">Stations Management Panel</li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <!-- /.row -->
            <!-- add user subpage -->
            <%@ include file="subpages/liststations.jsp"%>

            <!-- list users subpage -->

            <%@ include file="subpages/addstation.jsp"%>
