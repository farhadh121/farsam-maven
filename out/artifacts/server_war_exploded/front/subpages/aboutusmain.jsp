<section class="scrollable wrapper-lg">
    <div class="row">
        <div class="col-sm-9">
            <div class="blog-post">
                <div class="post-item">
                    <div class="post-media">
                        <img src="images/GoodRadio.png" class="img-full">
                    </div>
                    <div class="caption wrapper-lg">
                        <h2 class="post-title"><a href="#">About Us</a></h2>
                        <div class="post-sum">
                            <p>
                                <br><br>
                                This needs to be replaaced with actural stuff ja jf;kmfjaj a dnmsnj awh h; f ha;</p>
            ...
            <h4 class="m-t-lg m-b">Leave us your comment</h4>
            <form>
...
<!--TODO REPLACE THIS WITH TWITTWE-->
        <div class="col-sm-3">
