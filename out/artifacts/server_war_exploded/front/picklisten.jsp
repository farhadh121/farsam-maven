...
<head>
    <%@ include file="subpages/newlisten/listenhead.jsp" %>
</head>
    ...
    <section>
        <section class="hbox stretch">
            <aside class="bg-black dk nav-xs aside hidden-print" id="nav">
                ...
                <!-- .aside -->
                <%@ include file="subpages/newlisten/listenleftbar.jsp" %>
            </aside>
                <!-- /.aside -->
                <section id="content">
                    <section class="vbox">
                        <section class="w-f-md">
                            <section class="hbox stretch bg-black dker">
                                <%@ include file="subpages/newlisten/listensideplaylist.jsp"%>
                                <!-- / side content -->
                                <!-- Middle section-->
                                <%@ include file="subpages/newlisten/listenmiddlecontent.jsp"%>
                                <!-- / Middle section -->
                                <!-- right section-->
                                <%@ include file="subpages/newlisten/listenrightcontent.jsp"%>
                                <!--/ right section-->
                            </section>
                        </section>
                        <%@include file="subpages/newlisten/listenbottomplayer.jsp"%>
                    </section>
...
<script type="text/javascript" src="js/jPlayer/demo2.js"></script>
