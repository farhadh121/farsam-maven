...
<div class="m-t-n-xxs item pos-rlt">
    ...
    <%
		...
		String fname = sideLoggedInUser.getFirstName();
        ...
        while (sideItr.hasNext()) {
            ...
            if (sideStation.getStationID().equals((long) id)) {
				...
				String currStationName =sideStation.getStationName();
    ...
    <div class="pos-rlt">
		...
		FB.ui({
  method: 'feed',
  link: 'http://taghcheh.com/front/index.jsp',
  picture: 'http://taghcheh.com/front/images/GoodRadioSmall.png',
  caption: 'Listen to Music that you Love',
}, function(response){});
}
		(function(d, s, id) {var js, fjs = d.getElementsByTagName(s)[0];
		if (d.getElementById(id)) return;js = d.createElement(s); 
		js.id = id;js.src = "//connect.facebook.net/en_GB/all.js#xfbml=1&appId=419420661507146";
    ...
    <!-- Like Dislike Button-->
        ...
        <div class="share-btn" id="share-buttonLS" onclick="shareButton();">Share</div>
        <div class="stat-cnt">
