        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <%
                    ...
                    if( controller != null && controller.equals("deleterole") ){
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <%
                                ...
                                IRoleServiceProvider roleServiceProvider = (IRoleServiceProvider)context.getBean("roleFacade");
                                List<RoleEntity> list = roleServiceProvider.getAllRoles();
                                Iterator itr = list.iterator();
                                int counter = 1;
                                while( itr.hasNext() ){
                                    RoleEntity temp = (RoleEntity)itr.next();
                            %>
                            <tr>
                                <th><%=counter%>.</th>
                                <th><%=temp.getName()%></th>
                                <th><button class="btn btn-danger btn-flat" onclick="location.href='/deleteRoleController.htm?rolename=<%=temp.getName()%>'">Delete</button></th>
                            </tr>
