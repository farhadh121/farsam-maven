...
<section class="content-header">
    <h1>
        Dashboard
        <small>Artist Management Panel</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Artist Management Panel</li>
    </ol>
</section>
...
<!--Add Artist Module-->
<%@ include file="subpages/addartist.jsp" %>
    
<!--List Artists-->
<%@ include file="subpages/listartists.jsp" %>

<!--Edit Artist -->
<%@ include file="subpages/editartist.jsp" %>
