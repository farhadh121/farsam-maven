...
@Controller
public class EditSongGenreController {
    ...
    @RequestMapping( value = "/changeSongGenre.ajax", method = RequestMethod.POST )
    @ResponseBody
    private String changeSongGenre( @RequestBody String json ) throws Exception{

        ObjectMapper objectMapper = new ObjectMapper();
        ChangeSongGenreRequest changeSongGenreRequest = objectMapper.readValue(json, ChangeSongGenreRequest.class);

        try{
            String result = songServiceProvider.changeSongGenre( changeSongGenreRequest.getId(), changeSongGenreRequest.getName() );
